		...
		$("#selected").click(function(){
			...
			costIds.each(function(){
				...
				tab1.append("<tr>"+
								...
								"<td><input type='text' value='0' id='money' name='listMoneys' class='form-control' style='width:100px'></td>"+
								"<td><input type='text' name='listNames' class='form-control'></td>"+
...
<body>
	...
	<form action="expense/ExpenseUpdateServlet" id="f1" method="post"
		...
		<div class="row">
			...
			<div class="col-xs-7">
				<div class="form-group ">
					...
					<div class="col-xs-5 ">
						<input type="text" class="form-control" readonly="readonly" id="expenseTotal" name="expenseMoney"
		...
		<table class="table" id="tab1" >
			...
			<c:forEach items="${expenseListList}" var="detail">
				<tr>
					...
					<td>
					<input type='text' value='${detail.listMoney}' id='money'  name='listMoneys' class='form-control' style='width:100px'>
					</td>
					<td>
					<input type='text' name='listNames' value="${detail.listName}" class='form-control'>
					</td>
					<td><a href='javascript:void(0)' class='btn btn-danger' onclick='del(this)' >删除</a></td>
				</tr>
