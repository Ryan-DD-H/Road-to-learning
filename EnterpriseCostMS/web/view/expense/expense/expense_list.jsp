...
<div>
	...
	<form action="expense/ExpenseListQueryServlet" id="f1" method="post" class="form-inline">
		...
		<div class="row" style="padding: 15px;">
			<d:table class="table table-hover table-condensed" name="expenseList" pagesize="4" requestURI="expense/ExpenseListQueryServlet">
