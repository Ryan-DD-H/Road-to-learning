...
<form action="system/UsersUpdateServlet" id="f1" method="post" class="form-horizontal" >
		...
		<div class="row">
				...
				<div class="form-group ">
					...
					<div class="col-xs-4 ">
						<select name="roleId" class="form-control">
							<option ${user.roleId=='5'?'selected':'' } value="5">测试人员</option>
			...
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" name="usersSalary"  value="${user.usersSalary}" placeholder="请输入薪资" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9">
						<input type="text" class="form-control" required name="usersAccount"  readonly="readonly" value="${user.usersAccount }"  id="userAccount" placeholder="请输入用户账号" />
