...
<form action="system/UsersAddServlet" id="f1" method="post" class="form-horizontal">
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" required name="usersName" placeholder="请输入用户姓名" />
					</div>
				</div>
			</div>
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" name="usersAge" placeholder="请输入用户年龄" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" name="usersPhone" placeholder="请输入电话号码" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
				...
				<div class="form-group ">
					...
					<div class="col-xs-4 ">
						<select name="roleId" class="form-control">
							<option ${users.roleId=='5'?'selected':'' } value="5">测试人员</option>
							<option ${users.roleId=='4'?'selected':'' } value="4">普通员工</option>
							<option ${users.roleId=='2'?'selected':'' } value="2">部门经理</option>
							<option ${users.roleId=='3'?'selected':'' } value="3">财务人员</option>
							<option ${users.roleId=='1'?'selected':'' } value="1">超级管理员</option>
						</select>
					</div>
				</div>
			</div>
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" name="usersSalary" placeholder="请输入薪资" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9">
						<input type="text" class="form-control" required name="usersAccount" id="userAccount" placeholder="请输入用户账号" />
			...
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" required name="usersPwd" placeholder="请输入用户密码" />
					</div>
				</div>
			</div>
		</div>
