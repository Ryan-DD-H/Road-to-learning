...
<div class="navbar navbar-default" id="navbar">
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand">
					<small>
						<%--<i class="icon-leaf"></i>--%>
							<img src="resource/assets/images/logo1.png" alt="logo">
						知了堂费用管理系统
					</small>
				</a>
				<!-- /.brand -->
					...
					<li class="green">
						...
						<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
							<li class="dropdown-header">
                                ...
                                您有${messageNum}条报销单未审核
							</li>
						</ul>
					</li>
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="${users.profileUrl==null?'resource/assets/avatars/user.jpg':users.profileUrl}" alt="Jason's Photo" />
							<span class="user-info">
								<small>欢迎光临,${users.usersName}</small>
							</span>
							<i class="icon-caret-down"></i>
						</a>
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							<li>
								<a href="/view/system/user/userinfo_show.jsp"  target="mainframe">
									<i class="icon-user"></i>
									个人资料
								</a>
							</li>
							<li class="divider"></li>
							<li>
								<a href="system/UsersLoginOutServlet">
									<i class="icon-off"></i>
									退出
								</a>
							</li>
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active">
						<a href="view/main.jsp" target="mainframe">
								...
								<ul class="submenu">
									<c:forEach var="child" items="${menus}">
										<c:if test="${child.pMenuId==menu.menuId}">
											<li>
												<a href="${child.menuUrl}" target="mainframe">
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="view/main.jsp" style="width: 100%;border: 0px;"> </iframe>
			</div>
	...
	<script type="text/javascript">
		if ("ontouchend" in document)
			document.write("<script src='resource/assets/js/jquery.mobile.custom.min.js'>" + "<"+"/script>");
	</script>
