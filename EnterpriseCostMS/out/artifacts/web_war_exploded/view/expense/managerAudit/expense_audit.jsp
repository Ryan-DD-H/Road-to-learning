...
<body>
	...
	<form action="expense/AuditServlet" id="f1" method="post"
			...
			<div class="col-xs-7 ">
				 <div class="form-group">
				    ...
				    <div class="col-xs-9">
				     	<div class="radio">
				     	<label>
				    	<input type="radio" checked="checked" name="auditState" value="4"/>经理审核通过
				    	</label>
				    	</div>
				    	 <div class="radio">
				    	 <label>
				  	 	<input type="radio" name="auditState" value="-4"/>经理审核不通过
				  	 	</label>
				  	 	</div>
